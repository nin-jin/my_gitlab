...
;
	($.$my_gitlab_file) = class $my_gitlab_file extends ($.$mol_expander) {
		highlight(){
			return "";
		}
		Code(){
	...
	($mol_mem(($.$my_gitlab_file.prototype), "Code"));
...
(function ($) {
    ...
    (function ($$) {
        class $my_gitlab_file extends $.$my_gitlab_file {
            title() {
                return $mol_stub_code() + '.js';
            }
        }
        __decorate([
            $mol_mem
        ], $my_gitlab_file.prototype, "title", null);
        $$.$my_gitlab_file = $my_gitlab_file;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$my_gitlab) = class $my_gitlab extends ($.$mol_page) {
		anchoring(next){
			if(next !== undefined) return next;
			return true;
		}
		title(){
			return "GitLab Change Log";
		}
		Title(){
		...
		Lazy(){
			...
			(obj.value) = (next) => ((this.lazy_string(next)));
			(obj.options) = () => ({"true": "Lazy", "false": "Virtual"});
			return obj;
		}
		Anchoring(){
			const obj = new this.$.$mol_check_box();
			(obj.checked) = (next) => ((this.anchoring(next)));
			(obj.title) = () => ("Anchoring");
			return obj;
		}
		collapse(next){
		...
		Collapse(){
			const obj = new this.$.$mol_check_box();
			(obj.checked) = (next) => ((this.collapse(next)));
			(obj.title) = () => ("Collapse");
			return obj;
		}
		file_text(id){
		...
		Search_start_2(){
			const obj = new this.$.$mol_hotkey();
			(obj.key) = () => ({"F3": (next) => (this.search_start(next))});
			return obj;
		}
		attr(){
			return {"tabindex": 0, "my_gitlab_anchoring": (this.anchoring())};
		}
		head(){
			return [
				(this.Title()), 
		...
		File_view(id){
			...
			(obj.expanded) = (next) => ((this.file_expanded(id, next)));
			return obj;
		}
		plugins(){
			return [
	...
	($mol_mem(($.$my_gitlab.prototype), "anchoring"));
	($mol_mem(($.$my_gitlab.prototype), "Title"));
	($mol_mem(($.$my_gitlab.prototype), "Lights"));
	($mol_mem(($.$my_gitlab.prototype), "Sources"));
	($mol_mem(($.$my_gitlab.prototype), "search"));
	($mol_mem(($.$my_gitlab.prototype), "Search"));
	($mol_mem(($.$my_gitlab.prototype), "File_views"));
	($mol_mem(($.$my_gitlab.prototype), "lazy_string"));
	($mol_mem(($.$my_gitlab.prototype), "Lazy"));
	($mol_mem(($.$my_gitlab.prototype), "Anchoring"));
	($mol_mem(($.$my_gitlab.prototype), "collapse"));
	($mol_mem(($.$my_gitlab.prototype), "Collapse"));
	($mol_mem_key(($.$my_gitlab.prototype), "file_expanded"));
	($mol_mem(($.$my_gitlab.prototype), "Theme"));
	($mol_mem(($.$my_gitlab.prototype), "search_start"));
	($mol_mem(($.$my_gitlab.prototype), "Search_start_1"));
	($mol_mem(($.$my_gitlab.prototype), "Search_start_2"));
	($mol_mem_key(($.$my_gitlab.prototype), "File_view"));
